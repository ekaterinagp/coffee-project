        ...
        <div class="profile-details bg-dark-brown p-medium">
          ...
          <form id="form-profile" method="post">
            <label id="cName" class="grid" for="name">
              ...
              <input class="" data-type="string" data-min="2" data-max="20" type="text" data-type="string" name="inputName" placeholder="First name" value="<?= $jLoggedUser['cName']; ?>">
            ...
            <label id="cSurname" class="grid" for="lastName">
              ...
              <input class="" data-type="string" data-min="2" data-max="20" type="text" name="inputLastName" placeholder="Last name" value="<?= $jLoggedUser['cSurname']; ?>">
            ...
            <label id="cEmail" class="grid" for="email">
              ...
              <input class="" type="email" data-type="email" name="inputEmail" placeholder="email" value="<?= $jLoggedUser['cEmail']; ?>">
            ...
            <label id="nCityID" for="cityInput" class="grid">
              ...
              <select class="" data-type="integer" data-min="0" data-max="999" name="cityInput" value="<?= $jLoggedUser['nCityID'] ?>">
            ...
            <label id="cAddress" class="grid" for="userAddress">
              ...
              <input class="l" type="text" data-type="string" data-min="12" data-max="9999999999" name="inputAddress" placeholder="Address" value="<?= $jLoggedUser['cAddress']; ?>">
            ...
            <label id="cPhoneNo" class="grid" for="userPhone">
              ...
              <input class="" type="number" data-type="string" data-min="9999999" data-max="99999999" name="inputPhone" placeholder="phone number" value="<?= $jLoggedUser['cPhoneNo']; ?>">
            ...
            <label class="grid" for="loginName">
              ...
              <input class="" type="text" data-type="string" data-min="2" data-max="12" name="inputLoginName" placeholder="username" value="<?= $jLoggedUser['cUsername']; ?>">
